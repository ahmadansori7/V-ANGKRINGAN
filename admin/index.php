             ...
             <div class="modal fade" id="ProfileDetail" role="dialog" tabindex="-1">
              ...
              <div class="modal-dialog">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                    $totalpenghasilan  = mysqli_query($koneksi, "select sum(transaksi.subtotal) as total from transaksi where tanggal_transaksi = CURRENT_DATE() AND status ='2'");
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointBorderWidth: 2,
      data: [<?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as data6 from transaksi where tanggal_transaksi = CURRENT_DATE() - interval 6 day AND status ='2'");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['data6']; ?>
<?php 
}
?>, <?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as data5 from transaksi where tanggal_transaksi = CURRENT_DATE() - interval 5 day AND status ='2'");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['data5']; ?>
<?php 
}
?>, <?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as data4 from transaksi where tanggal_transaksi = CURRENT_DATE() - interval 4 day AND status ='2'");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['data4']; ?>
<?php 
}
?>, <?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as data3 from transaksi where tanggal_transaksi = CURRENT_DATE() - interval 3 day AND status ='2';");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['data3']; ?>
<?php 
}
?>, <?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as data2 from transaksi where tanggal_transaksi = CURRENT_DATE() - interval 2 day AND status ='2'");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['data2']; ?>
<?php 
}
?> , <?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as data1 from transaksi where tanggal_transaksi = CURRENT_DATE() - interval 1 day AND status ='2'");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['data1']; ?>
<?php 
}
?>, <?php
$totaltransaksi  = mysqli_query($koneksi, "select COALESCE(SUM(subtotal),0) as now from transaksi where tanggal_transaksi = CURRENT_DATE() AND status ='2'");
while ($row = mysqli_fetch_array($totaltransaksi)) {?>
<?php echo $row['now']; ?>
<?php 
}
